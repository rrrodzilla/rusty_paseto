    ...
    typography: ({ theme }) => ({
      DEFAULT: {
        css: {
          ...
          '--tw-prose-links': 'oklch(50.5% 0.213 27.518)',
          '--tw-prose-links-hover': 'oklch(45% 0.2 27.518)',
          '--tw-prose-links-underline': 'oklch(50.5% 0.213 27.518 / 0.3)',
          ...
          '--tw-prose-invert-links': 'oklch(65% 0.18 27.518)',
          '--tw-prose-invert-links-hover': 'oklch(50.5% 0.213 27.518)',
          '--tw-prose-invert-links-underline': 'oklch(50.5% 0.213 27.518 / 0.3)',
